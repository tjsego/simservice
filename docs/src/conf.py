...
# -*- coding: utf-8 -*-
#
# simservice documentation build configuration file
#
...
htmlhelp_basename = 'SimServicedoc'
...
man_pages = [
    (master_doc, 'SimService', 'SimService Documentation',
     [author], 1)
]
